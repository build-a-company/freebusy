...
type Booking struct {
	...
	State BookingState `protobuf:"varint,9,opt,name=state,proto3,enum=freebusy.scheduling.v1.BookingState" json:"state,omitempty"`
	...
	CancelReason CancelReason `protobuf:"varint,17,opt,name=cancel_reason,json=cancelReason,proto3,enum=freebusy.scheduling.v1.CancelReason" json:"cancel_reason,omitempty"`
...
func (x *Booking) Reset() {
	*x = Booking{}
	mi := &file_freebusy_scheduling_v1_scheduling_proto_msgTypes[0]
...
func (*Booking) Descriptor() ([]byte, []int) {
	return file_freebusy_scheduling_v1_scheduling_proto_rawDescGZIP(), []int{0}
}
...
func (x *Occupancy) Reset() {
	*x = Occupancy{}
	mi := &file_freebusy_scheduling_v1_scheduling_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Occupancy) Descriptor() ([]byte, []int) {
	return file_freebusy_scheduling_v1_scheduling_proto_rawDescGZIP(), []int{1}
}
...
func (x *BookingGuests) Reset() {
	*x = BookingGuests{}
	mi := &file_freebusy_scheduling_v1_scheduling_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*BookingGuests) Descriptor() ([]byte, []int) {
	return file_freebusy_scheduling_v1_scheduling_proto_rawDescGZIP(), []int{2}
}
...
const file_freebusy_scheduling_v1_scheduling_proto_rawDesc = "" +
	...
	"\rassigned_unit\x18\b \x01(\tB\x03\xe0A\x03R\fassignedUnit\x12Q\n" +
	"\x05state\x18\t \x01(\x0e2$.freebusy.scheduling.v1.BookingStateB\x15\xe0A\x03ڵ\x18\x0e\x12\fPENDING_HOLDR\x05state\x12I\n" +
	...
	"attributes\x12N\n" +
	"\rcancel_reason\x18\x11 \x01(\x0e2$.freebusy.scheduling.v1.CancelReasonB\x03\xe0A\x03R\fcancelReason\x12@\n" +
	...
	"\x04etag\x18\x17 \x01(\tR\x04etag:J\xeaAG\n" +
	"\x1efreebusy.scheduling.v1/Booking\x12\x12bookings/{booking}*\bbookings2\abookingJ\x04\b\x02\x10\x03J\x04\b\x04\x10\x05\"}\n" +
	"\tOccupancy\x12\"\n" +
...
var (
	file_freebusy_scheduling_v1_scheduling_proto_rawDescOnce sync.Once
	file_freebusy_scheduling_v1_scheduling_proto_rawDescData []byte
)

func file_freebusy_scheduling_v1_scheduling_proto_rawDescGZIP() []byte {
	file_freebusy_scheduling_v1_scheduling_proto_rawDescOnce.Do(func() {
		file_freebusy_scheduling_v1_scheduling_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_freebusy_scheduling_v1_scheduling_proto_rawDesc), len(file_freebusy_scheduling_v1_scheduling_proto_rawDesc)))
	})
	return file_freebusy_scheduling_v1_scheduling_proto_rawDescData
}

var file_freebusy_scheduling_v1_scheduling_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_freebusy_scheduling_v1_scheduling_proto_goTypes = []any{
	(*Booking)(nil),                   // 0: freebusy.scheduling.v1.Booking
	...
	(CancelReason)(0),                 // 11: freebusy.scheduling.v1.CancelReason
...
var file_freebusy_scheduling_v1_scheduling_proto_depIdxs = []int32{
	...
	7,  // 5: freebusy.scheduling.v1.Booking.hold_expire_time:type_name -> google.protobuf.Timestamp
	8,  // 6: freebusy.scheduling.v1.Booking.price:type_name -> google.type.Money
	8,  // 7: freebusy.scheduling.v1.Booking.discount:type_name -> google.type.Money
	8,  // 8: freebusy.scheduling.v1.Booking.total:type_name -> google.type.Money
	9,  // 9: freebusy.scheduling.v1.Booking.price_components:type_name -> freebusy.shared.v1.PriceComponent
	10, // 10: freebusy.scheduling.v1.Booking.attributes:type_name -> google.protobuf.Struct
	11, // 11: freebusy.scheduling.v1.Booking.cancel_reason:type_name -> freebusy.scheduling.v1.CancelReason
	7,  // 12: freebusy.scheduling.v1.Booking.create_time:type_name -> google.protobuf.Timestamp
	7,  // 13: freebusy.scheduling.v1.Booking.update_time:type_name -> google.protobuf.Timestamp
	7,  // 14: freebusy.scheduling.v1.Booking.confirm_time:type_name -> google.protobuf.Timestamp
...
func init() { file_freebusy_scheduling_v1_scheduling_proto_init() }
func file_freebusy_scheduling_v1_scheduling_proto_init() {
	if File_freebusy_scheduling_v1_scheduling_proto != nil {
		return
	}
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_freebusy_scheduling_v1_scheduling_proto_rawDesc), len(file_freebusy_scheduling_v1_scheduling_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_freebusy_scheduling_v1_scheduling_proto_goTypes,
		DependencyIndexes: file_freebusy_scheduling_v1_scheduling_proto_depIdxs,
		MessageInfos:      file_freebusy_scheduling_v1_scheduling_proto_msgTypes,
	}.Build()
	File_freebusy_scheduling_v1_scheduling_proto = out.File
	file_freebusy_scheduling_v1_scheduling_proto_goTypes = nil
	file_freebusy_scheduling_v1_scheduling_proto_depIdxs = nil
}
