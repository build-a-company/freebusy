...
# `rfc/rfc5545/event/types/` — Prisma schema
...
### `EventCalendarTime` → `calendar_times`
...
| `value_case` | `EventCalendarTimeValueCase` | nullable |
| `event_id` | `CHAR(26)` | not null |

### `EventExtensionProperty` → `extension_properties`
...
- `EventClassification`: PUBLIC, PRIVATE, CONFIDENTIAL
- `Transparency`: OPAQUE, TRANSPARENT
- `EventCalendarTimeValueCase`: DATE, DATE_TIME
