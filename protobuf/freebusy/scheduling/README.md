...
**Package:** `freebusy.scheduling.v1`
...
| `unit` | `string` | `REQUIRED` | The unit being booked. Format: resources/{resource} |
...
| `unit` | `string` | `OPTIONAL` | The new unit, when changing it as part of the reschedule. Format: resources/{resource} |
