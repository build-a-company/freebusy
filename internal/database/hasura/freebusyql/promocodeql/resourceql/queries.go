...
func (h *queryHandler) List(ctx context.Context, req ...*ListRequest) ([]PromocodeResource, error) {
	var out []PromocodeResource
	var r ListRequest
...
func (h *queryHandler) Find(ctx context.Context, req ...*ListRequest) (*PromocodeResource, error) {
	var out []PromocodeResource
	var r ListRequest
	if len(req) > 0 && req[0] != nil {
		r = *req[0]
...
func (h *queryHandler) Aggregate(ctx context.Context, req ...*AggregateRequest) (*PromocodeResourceAggExp, error) {
	var out *PromocodeResourceAggExp
...
func (h *queryHandler) Get(ctx context.Context, id string) (*PromocodeResource, error) {
	var out *PromocodeResource
	args := map[string]any{}
