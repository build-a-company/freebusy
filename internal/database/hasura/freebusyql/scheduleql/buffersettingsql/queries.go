...
func (h *queryHandler) List(ctx context.Context, req ...*ListRequest) ([]ScheduleBufferSettings, error) {
	var out []ScheduleBufferSettings
	var r ListRequest
...
func (h *queryHandler) Find(ctx context.Context, req ...*ListRequest) (*ScheduleBufferSettings, error) {
	var out []ScheduleBufferSettings
	var r ListRequest
	if len(req) > 0 && req[0] != nil {
		r = *req[0]
...
func (h *queryHandler) Aggregate(ctx context.Context, req ...*AggregateRequest) (*ScheduleBufferSettingsAggExp, error) {
	var out *ScheduleBufferSettingsAggExp
...
func (h *queryHandler) Get(ctx context.Context, id string) (*ScheduleBufferSettings, error) {
	var out *ScheduleBufferSettings
	args := map[string]any{}
