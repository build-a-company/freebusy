...
func (h *queryHandler) List(ctx context.Context, req ...*ListRequest) ([]ScheduleStayConstraints, error) {
	var out []ScheduleStayConstraints
	var r ListRequest
	...
	if !graphql.IsOmitted(r.GetOrderBy()) {
		args["order_by"] = graphql.VarPtr(r.GetOrderBy(), "[ScheduleStayConstraintsOrderByExp!]")
	}
	if !graphql.IsOmitted(r.GetWhere()) {
		args["where"] = graphql.VarPtr(r.GetWhere(), "ScheduleStayConstraintsBoolExp")
	}
	res := <-h.gql.QueryFields(ctx, "scheduleStayConstraints", &out, args)
	return out, res.Error
}

func (h *queryHandler) Find(ctx context.Context, req ...*ListRequest) (*ScheduleStayConstraints, error) {
	var out []ScheduleStayConstraints
	var r ListRequest
	if len(req) > 0 && req[0] != nil {
		r = *req[0]
...
func (h *queryHandler) Aggregate(ctx context.Context, req ...*AggregateRequest) (*ScheduleStayConstraintsAggExp, error) {
	var out *ScheduleStayConstraintsAggExp
...
func (h *queryHandler) Get(ctx context.Context, id string) (*ScheduleStayConstraints, error) {
	var out *ScheduleStayConstraints
	args := map[string]any{}
