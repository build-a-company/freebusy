...
type AvailabilityException struct {
	...
	Reason *string `gorm:"column:reason;index:idx_availability_exceptions_reason_trgm,type:gin,expression:reason gin_trgm_ops" json:"reason,omitempty"`
	// Creation timestamp.
	...
	// Parent reference to Resource (from the AIP resource pattern). TODO: unresolved reference to Resource (not in this generation set); kept as a plain indexed column.
