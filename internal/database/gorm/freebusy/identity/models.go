...
type User struct {
	...
	// Display name.
	DisplayName *string `gorm:"column:display_name;index:idx_users_display_name_trgm,type:gin,expression:display_name gin_trgm_ops" json:"display_name,omitempty"`
	// Avatar image URL.
...
type GuestPreferences struct {
	...
	Dietary pq.StringArray `gorm:"column:dietary;type:text[];index:idx_guest_preferences_dietary_gin,type:gin" json:"dietary,omitempty"`
	// Accessibility needs (e.g. "wheelchair", "hearing-accessible", "ground-floor").
	Accessibility pq.StringArray `gorm:"column:accessibility;type:text[];index:idx_guest_preferences_accessibility_gin,type:gin" json:"accessibility,omitempty"`
	...
	SpecialRequests pq.StringArray `gorm:"column:special_requests;type:text[];index:idx_guest_preferences_special_requests_gin,type:gin" json:"special_requests,omitempty"`
