...
type Booking struct {
	...
	State *BookingState `gorm:"column:state;default:'PENDING_HOLD';check:chk_bookings_state,state IN ('PENDING_HOLD','CONFIRMED','CANCELLED','EXPIRED','COMPLETED','NO_SHOW')" json:"state,omitempty"`
	...
	PromoCodeID *string `gorm:"column:promo_code;index:idx_bookings_promo_code" json:"promo_code,omitempty"`
	...
	CancelReason *CancelReason `gorm:"column:cancel_reason;check:chk_bookings_cancel_reason,cancel_reason IN ('REQUESTED_BY_CUSTOMER','REQUESTED_BY_OPERATOR','PAYMENT_FAILED','NO_SHOW','OTHER')" json:"cancel_reason,omitempty"`
	...
	ContactID *string         `gorm:"column:contact_id;index:idx_bookings_contact_id" json:"contact_id,omitempty"`
	...
	OccupancyID *string    `gorm:"column:occupancy_id;index:idx_bookings_occupancy_id" json:"occupancy_id,omitempty"`
	...
	WindowID string             `gorm:"column:window_id;not null;index:idx_bookings_window_id" json:"window_id" validate:"required"`
	Window   *shared.TimeWindow `gorm:"foreignKey:WindowID;constraint:OnDelete:CASCADE" json:"window,omitempty"`
	// Foreign key to Money.
	PriceID *string       `gorm:"column:price_id;index:idx_bookings_price_id" json:"price_id,omitempty"`
	Price   *common.Money `gorm:"foreignKey:PriceID;constraint:OnDelete:SET NULL" json:"price,omitempty"`
	// Foreign key to Money.
	DiscountID *string       `gorm:"column:discount_id;index:idx_bookings_discount_id" json:"discount_id,omitempty"`
	Discount   *common.Money `gorm:"foreignKey:DiscountID;constraint:OnDelete:SET NULL" json:"discount,omitempty"`
	// Foreign key to Money.
	TotalID *string       `gorm:"column:total_id;index:idx_bookings_total_id" json:"total_id,omitempty"`
	Total   *common.Money `gorm:"foreignKey:TotalID;constraint:OnDelete:SET NULL" json:"total,omitempty"`
	// Foreign key to Money.
	RefundAmountID *string       `gorm:"column:refund_amount_id;index:idx_bookings_refund_amount_id" json:"refund_amount_id,omitempty"`
	RefundAmount   *common.Money `gorm:"foreignKey:RefundAmountID;constraint:OnDelete:SET NULL" json:"refundamount,omitempty"`
}

func (*Booking) TableName() string { return "scheduling.bookings" }
...
type Occupancy struct {
	...
	Bookings []Booking `gorm:"foreignKey:OccupancyID" json:"bookings,omitempty"`
}

func (*Occupancy) TableName() string { return "scheduling.occupancies" }
