...
type Guest struct {
	...
	Gender *Gender `gorm:"column:gender;check:chk_resource_gender,gender IN ('MALE','FEMALE','OTHER','UNDISCLOSED')" json:"gender,omitempty"`
	// Date of birth.
	...
	AgeGroup *AgeGroup `gorm:"column:age_group;check:chk_resource_age_group,age_group IN ('ADULT','CHILD','INFANT')" json:"age_group,omitempty"`
	...
	BookingID string `gorm:"column:booking_id;not null;index:idx_resource_booking_id" json:"booking_id" validate:"required"`
	// Foreign key to IdDocument.
	IDDocumentID *string     `gorm:"column:id_document_id;index:idx_resource_id_document_id" json:"id_document_id,omitempty"`
	...
	PermanentAddressID *string               `gorm:"column:permanent_address_id;index:idx_resource_permanent_address_id" json:"permanent_address_id,omitempty"`
	...
	// Foreign key to PostalAddress.
	LocalAddressID *string               `gorm:"column:local_address_id;index:idx_resource_local_address_id" json:"local_address_id,omitempty"`
	...
	ForeignerID *string           `gorm:"column:foreigner_id;index:idx_resource_foreigner_id" json:"foreigner_id,omitempty"`
	...
	PreferencesID *string           `gorm:"column:preferences_id;index:idx_resource_preferences_id" json:"preferences_id,omitempty"`
	Preferences   *GuestPreferences `gorm:"foreignKey:PreferencesID;constraint:OnDelete:SET NULL" json:"preferences,omitempty"`
}

func (*Guest) TableName() string { return "guest.resource" }
...
type IdDocument struct {
	...
	Resource []Guest `gorm:"foreignKey:IDDocumentID" json:"resource,omitempty"`
}

func (*IdDocument) TableName() string { return "guest.id_documents" }
...
type ForeignerDetails struct {
	...
	Resource []Guest `gorm:"foreignKey:ForeignerID" json:"resource,omitempty"`
}

func (*ForeignerDetails) TableName() string { return "guest.foreigner_details" }
...
type GuestPreferences struct {
	...
	Smoking *SmokingPreference `gorm:"column:smoking;check:chk_preferences_smoking,smoking IN ('NON_SMOKING','SMOKING')" json:"smoking,omitempty"`
	// Preferred bed type.
	Bed *BedPreference `gorm:"column:bed;check:chk_preferences_bed,bed IN ('NO_PREFERENCE','KING','QUEEN','TWIN','SINGLE')" json:"bed,omitempty"`
	// Dietary requirements / requests (e.g. "vegetarian", "jain", "halal", "gluten-free").
	Dietary pq.StringArray `gorm:"column:dietary;type:text[];index:idx_preferences_dietary_gin,type:gin" json:"dietary,omitempty"`
	// Accessibility needs (e.g. "wheelchair", "hearing-accessible", "ground-floor").
	Accessibility pq.StringArray `gorm:"column:accessibility;type:text[];index:idx_preferences_accessibility_gin,type:gin" json:"accessibility,omitempty"`
	...
	SpecialRequests pq.StringArray `gorm:"column:special_requests;type:text[];index:idx_preferences_special_requests_gin,type:gin" json:"special_requests,omitempty"`
	...
	Resource []Guest `gorm:"foreignKey:PreferencesID" json:"resource,omitempty"`
}

func (*GuestPreferences) TableName() string { return "guest.preferences" }
