...
type Property struct {
	...
	DisplayName string `gorm:"column:display_name;not null;index:idx_properties_display_name_trgm,type:gin,expression:display_name gin_trgm_ops" json:"display_name" validate:"required"`
	...
	Tags pq.StringArray `gorm:"column:tags;type:text[];index:idx_properties_tags_gin,type:gin" json:"tags,omitempty"`
...
type Unit struct {
	...
	DisplayName string `gorm:"column:display_name;not null;index:idx_units_display_name_trgm,type:gin,expression:display_name gin_trgm_ops" json:"display_name" validate:"required"`
	...
	Tags pq.StringArray `gorm:"column:tags;type:text[];index:idx_units_tags_gin,type:gin" json:"tags,omitempty"`
	// Arbitrary attributes used for templating, policy, and segmentation.
	Attributes json.RawMessage `gorm:"column:attributes;type:jsonb" json:"attributes,omitempty"`
...
type Policy struct {
	...
	HouseRules pq.StringArray `gorm:"column:house_rules;type:text[];index:idx_policies_house_rules_gin,type:gin" json:"house_rules,omitempty"`
