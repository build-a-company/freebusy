...
func promoCodeFromRow(row *resourceql.PromocodeResource) *promocodepbv1.PromoCode {
	if row == nil {
		return nil
	}
...
// reference names from their stored bare ids.
func redemptionFromRow(row *redemptionsql.PromocodeRedemptions) *promocodepbv1.Redemption {
	if row == nil {
		return nil
	}
...
func promocodeRedemptionWindowFromRow(row *redemptionwindowsql.PromocodeRedemptionWindows) *promocodepbv1.RedemptionWindow {
	if row == nil {
		return nil
	}
...
func promocodeUsageLimitsFromRow(row *usagelimitsql.PromocodeUsageLimits) *promocodepbv1.UsageLimits {
	if row == nil {
		return nil
	}
