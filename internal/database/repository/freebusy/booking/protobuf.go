...
func bookingFromRow(row *resourceql.BookingResource) *bookingpbv1.Booking {
	if row == nil {
		return nil
	}
...
// bookingOccupancyToCreateInput maps the value-object proto onto its client
// insert input; the adapter mints the id and wires the reference.
func bookingOccupancyToCreateInput(in *bookingpbv1.Occupancy) occupanciesql.CreateInput {
...
// bookingOccupancyFromRow re-hydrates the value-object proto from a client row.
func bookingOccupancyFromRow(row *occupanciesql.BookingOccupancies) *bookingpbv1.Occupancy {
	if row == nil {
		return nil
	}
