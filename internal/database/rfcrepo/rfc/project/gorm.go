...
func (r *GormProjectRepository) Create(ctx context.Context, in *projectv1.Project) (*projectv1.Project, error) {
	id := repox.NewULID()
	if in.GetName() != "" {
	...
	in = proto.Clone(in).(*projectv1.Project)
...
func (r *GormProjectRepository) Get(ctx context.Context, name string) (*projectv1.Project, error) {
...
func (r *GormProjectRepository) get(ctx context.Context, id string) (*projectv1.Project, error) {
...
// AfterRead hook.
func (r *GormProjectRepository) toProto(ctx context.Context, m *project.Project) (*projectv1.Project, error) {
...
func (r *GormProjectRepository) List(ctx context.Context, in repox.ListInput) ([]*projectv1.Project, string, error) {
	return r.list(ctx, r.DB, in)
}

func (r *GormProjectRepository) list(ctx context.Context, scope *gorm.DB, in repox.ListInput) ([]*projectv1.Project, string, error) {
	...
	items := make([]*projectv1.Project, 0, len(rows))
	for i := range rows {
...
func (r *GormProjectRepository) Update(ctx context.Context, in *projectv1.Project, paths []string) (*projectv1.Project, error) {
	ids, err := repox.SplitName(in.GetName(), "projects")
	if err != nil {
		return nil, err
	}
	...
	err = r.DB.Transaction(func(tx *gorm.DB) error {
		...
		merged := proto.Clone(existingPB).(*projectv1.Project)
