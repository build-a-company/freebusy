...
type CalendarRepository interface {
	...
	Create(ctx context.Context, m *calendarv1.Calendar) (*calendarv1.Calendar, error)
	// Get returns the record addressed by its resource name, or
	// repox.ErrNotFound.
	Get(ctx context.Context, name string) (*calendarv1.Calendar, error)
	// List returns one page of records.
	List(ctx context.Context, in repox.ListInput) ([]*calendarv1.Calendar, string, error)
	...
	// (repox.ErrConflict).
	Update(ctx context.Context, m *calendarv1.Calendar, paths []string) (*calendarv1.Calendar, error)
...
type CalendarHooks struct {
	...
	BeforeCreate func(ctx context.Context, m *calendarv1.Calendar) error
	// AfterRead runs on every record a read returns (Get, List, and the
	// re-reads writes return).
	AfterRead func(ctx context.Context, m *calendarv1.Calendar) error
	// BeforeUpdate runs after the mask is applied to the merged record,
	// before it is written.
	BeforeUpdate func(ctx context.Context, existing, merged *calendarv1.Calendar, paths []string) error
