...
func (r *GormCalendarRepository) Create(ctx context.Context, in *calendarv1.Calendar) (*calendarv1.Calendar, error) {
	id := repox.NewULID()
	if in.GetName() != "" {
	...
	in = proto.Clone(in).(*calendarv1.Calendar)
...
func (r *GormCalendarRepository) Get(ctx context.Context, name string) (*calendarv1.Calendar, error) {
...
func (r *GormCalendarRepository) get(ctx context.Context, id string) (*calendarv1.Calendar, error) {
...
// AfterRead hook.
func (r *GormCalendarRepository) toProto(ctx context.Context, m *calendar.Calendar) (*calendarv1.Calendar, error) {
...
func (r *GormCalendarRepository) List(ctx context.Context, in repox.ListInput) ([]*calendarv1.Calendar, string, error) {
	return r.list(ctx, r.DB, in)
}

func (r *GormCalendarRepository) list(ctx context.Context, scope *gorm.DB, in repox.ListInput) ([]*calendarv1.Calendar, string, error) {
	...
	items := make([]*calendarv1.Calendar, 0, len(rows))
	for i := range rows {
...
func (r *GormCalendarRepository) Update(ctx context.Context, in *calendarv1.Calendar, paths []string) (*calendarv1.Calendar, error) {
	ids, err := repox.SplitName(in.GetName(), "calendars")
	if err != nil {
		return nil, err
	}
	...
	err = r.DB.Transaction(func(tx *gorm.DB) error {
		...
		merged := proto.Clone(existingPB).(*calendarv1.Calendar)
