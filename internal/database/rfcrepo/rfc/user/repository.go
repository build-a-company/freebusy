...
type UserRepository interface {
	...
	Create(ctx context.Context, m *userv1.User) (*userv1.User, error)
	// Get returns the record addressed by its resource name, or
	// repox.ErrNotFound.
	Get(ctx context.Context, name string) (*userv1.User, error)
	// List returns one page of records.
	List(ctx context.Context, in repox.ListInput) ([]*userv1.User, string, error)
	...
	// (repox.ErrConflict).
	Update(ctx context.Context, m *userv1.User, paths []string) (*userv1.User, error)
...
type UserHooks struct {
	...
	BeforeCreate func(ctx context.Context, m *userv1.User) error
	// AfterRead runs on every record a read returns (Get, List, and the
	// re-reads writes return).
	AfterRead func(ctx context.Context, m *userv1.User) error
	// BeforeUpdate runs after the mask is applied to the merged record,
	// before it is written.
	BeforeUpdate func(ctx context.Context, existing, merged *userv1.User, paths []string) error
